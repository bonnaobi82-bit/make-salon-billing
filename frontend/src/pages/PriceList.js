...
const FACIAL_PRICE_IMAGE = 'https://customer-assets.emergentagent.com/job_beauty-billing-4/artifacts/q685oi9w_WhatsApp%20Image%202026-04-18%20at%2011.03.24%20AM%20%282%29.jpeg';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1 space-y-4">
            <div className="stat-card">
              ...
              <h3 className="text-sm font-medium text-[#1B3B36] mt-4 mb-3 flex items-center gap-2">
                <ImageIcon size={16} className="text-[#D4AF37]" />
                Facial & Top Up Price Card
              </h3>
              <div className="rounded-xl overflow-hidden border border-[#E8EAE6]">
                <img
                  src={FACIAL_PRICE_IMAGE}
                  alt="Facial Price List"
                  className="w-full h-auto"
                  data-testid="facial-price-list-image"
                />
              </div>
